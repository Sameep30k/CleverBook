...
var _hsq = _hsq || [];
var _paq = _paq || [];
_hsq.push(["setPortalId", 21811999]);
...
_hsq.push(["addHashedCookieDomain", "79892040"]);
_hsq.push([
  "embedHubSpotScript",
  "https://js-na1.hs-scripts.com/21811999.js",
  "hs-script-loader",
]);
...
/** _anon_wrapper_ **/ (function () {
  ...
  hstc.tracking.Runner.prototype.processHsq = function (t) {
    ...
    hstc.utils.search2dArray(
      e,
      1,
      ["addHashedCookieDomain", "enableSecureCookie"],
      t
    );
  ...
  !(function (t) {
    ...
    try {
      O.apply((A = P.call(v.childNodes)), v.childNodes);
        ...
        for (; o--; ) {
          ...
          if (
            ...
            (s = l(
              ...
              (K.test(a[0].type) && e.parentNode) || e
            ))
          ) {
            a.splice(o, 1);
            if (!(t = s.length && ft(a))) {
