...
!(function () {
  ...
  function me() {
    ...
    t &&
      ...
      t
        ...
        .catch(function (e) {
          t.id === Xr() &&
            (e && ar(0, 1, e.name, e.message, e.stack), (fe = null), me());
        }));
  }
  function be(t) {
    var e = Ee(t);
                  ...
                  switch (A) {
                    case "tag":
                      (j = Xe(E)),
                        (R = I ? -1 : 1),
                        r.push(E.id * R),
                        E.parent && T && r.push(E.parent),
                        E.previous && T && r.push(E.previous),
                        r.push(S ? "*M" : N[A]),
                        j &&
                          2 === j.length &&
                          r.push(
                    ...
                    case "attributes":
                      for (L in N[A])
                        void 0 !== N[A][L] && r.push(qe(L, N[A][L], x));
                      break;
                    case "value":
                      Nt(E.metadata.fraud, E.id, N[A]),
                        r.push(m(N[A], N.tag, x, I));
                  }
              z.label = 10;
            case 10:
              return w++, [3, 7];
  ...
  function Qe() {
    for (var t = [], e = 0, n = Be; e < n.length; e++) {
      var a = n[e],
        r = Jt(a.node);
      r
        ? ((a.state.data.id = r), (Ve[r] = a.state.data), Ue.push(a.state))
        : t.push(a);
    }
  ...
  function tn(t, e, n, a) {
    ...
    (e.interaction = n > e.interaction ? n : e.interaction),
      ...
      e.id
        ? ((e.id in Ve && r) || !(e.id in Ve)) &&
          ((Ve[e.id] = e), Ue.push(en(e)))
        : Be.push({ node: t, state: en(e) });
  }
  function en(t) {
    return {
      time: s(),
  ...
  function rn(t) {
    ...
    if (e) {
      ...
      an.push({
        time: s(t),
        event: 42,
        data: { target: Ma(t), type: e.type, value: n, checksum: a },
      }),
        ge(Ia.bind(this, 42));
    }
  }
  ...
  var gn = [];
  function mn(t, e) {
    gn.push({ time: s(e), event: 38, data: { target: Ma(e), action: t } }),
      ge(Ia.bind(this, 38));
  }
  function bn() {
    gn = [];
  ...
  function kn(t) {
    ...
    if (e && e.type && n) {
      ...
      wn.length > 0 && wn[wn.length - 1].data.target === r.target && wn.pop(),
        wn.push({ time: s(t), event: 27, data: r }),
        Y(yn),
        (yn = X(En, 1e3, 27));
    }
  }
  ...
  function xn(t, e, n) {
    ...
    null !== i &&
      null !== o &&
      _n({ time: s(n), event: t, data: { target: Ma(n), x: i, y: o } });
  }
  function Mn(t, e, n) {
    var a = Gt(e),
      r = a ? a.contentDocument.documentElement : document.documentElement,
    ...
    if (i)
      for (var u = 0; u < i.length; u++) {
        ...
        (l = l && a ? l + Math.round(a.offsetLeft) : l),
          ...
          null !== l &&
            null !== d &&
            _n({ time: o, event: t, data: { target: Ma(n), x: l, y: d } });
      }
  }
  function _n(t) {
    switch (t.event) {
        ...
        : "caretRangeFromPoint" in document &&
          (o =
            null === (a = document.caretRangeFromPoint(t, e)) || void 0 === a
              ? void 0
              : a.startContainer),
      o || (o = document.elementFromPoint(t, e)),
      o && o.nodeType === Node.TEXT_NODE && (o = o.parentNode),
      null === (i = null === (r = ee(o)) || void 0 === r ? void 0 : r.hash) ||
      void 0 === i
        ? void 0
        : i[1]
    );
  ...
  function Yn(t) {
    ...
    if (
      ...
      null !== Wn && null !== Pn.start && n !== e.anchorNode && (Y(Xn), qn(21)),
        (Pn = {
          start: e.anchorNode,
  ...
  function Un() {
    (Wn = null), (Pn = { start: 0, startOffset: 0, end: 0, endOffset: 0 });
  }
  var Fn,
    Vn,
    Bn = [];
  function Jn(t) {
    Bn.push({ time: s(t), event: 39, data: { target: Ma(t) } }),
      ge(Ia.bind(this, 39));
  }
  function Kn() {
    Bn = [];
  ...
  function ta(t) {
    !(function (t) {
      ...
      t.nodeType === Node.DOCUMENT_NODE &&
        (ln(t),
        (function (t) {
          ci(t, "cut", mn.bind(this, 0), !0),
            ci(t, "copy", mn.bind(this, 1), !0),
            ci(t, "paste", mn.bind(this, 2), !0);
        })(t),
        (function (t) {
          ci(t, "mousedown", xn.bind(this, 13, t), !0),
            ci(t, "mouseup", xn.bind(this, 14, t), !0),
            ci(t, "mousemove", xn.bind(this, 12, t), !0),
            ci(t, "wheel", xn.bind(this, 15, t), !0),
            ci(t, "dblclick", xn.bind(this, 16, t), !0),
            ci(t, "touchstart", Mn.bind(this, 17, t), !0),
            ci(t, "touchend", Mn.bind(this, 18, t), !0),
            ci(t, "touchmove", Mn.bind(this, 19, t), !0),
            ci(t, "touchcancel", Mn.bind(this, 20, t), !0);
        })(t),
        (function (t) {
          ci(t, "input", kn, !0);
        })(t),
  ...
  var ea = Object.freeze({
      ...
      start: function () {
        (Ca = []),
          ...
          ci(window, "resize", Dn),
          Dn(),
          ci(document, "visibilitychange", Qn),
          Qn(),
          (jn = []),
          Ln(),
          Un(),
      ...
      stop: function () {
        (Ca = []),
          ...
          bn(),
          Y(Sn),
          Tn.length > 0 && In(Tn[Tn.length - 1].event),
          Y(yn),
          On(),
          An(),
          $n(),
        ...
        switch (
          ...
          case "product":
            Cr(5, t[a]),
              Cr(10, t.name),
              Cr(12, t.sku),
              t.brand && Cr(6, t.brand.name);
            break;
          case "aggregaterating":
            t.ratingValue &&
              (W(11, ra(t.ratingValue, 100)),
              W(18, ra(t.bestRating)),
              W(19, ra(t.worstRating))),
              W(12, ra(t.ratingCount)),
              W(17, ra(t.reviewCount));
            break;
          case "person":
            Cr(8, t.name);
            break;
          case "offer":
            Cr(7, t.availability),
              Cr(14, t.itemCondition),
              Cr(13, t.priceCurrency),
              Cr(12, t.sku),
              W(13, ra(t.price));
            break;
          case "brand":
      ...
      case Node.ELEMENT_NODE:
        ...
        switch (
          ...
          case "BASE":
            ...
            break;
          case "STYLE":
            var N = { tag: p, attributes: v, value: sa(h) };
            ce[i](t, o, N, e);
            break;
          case "IFRAME":
            var T = t,
            ...
            Kt(T) &&
              (!(function (t) {
                !1 === ae(t) &&
                  ci(t, "load", xa.bind(this, t, "childList"), !0);
              })(T),
              (S.attributes["*O"] = "true"),
              T.contentDocument &&
                T.contentWindow &&
          ...
          case "LINK":
            if (Lr && "stylesheet" === v.rel) {
              for (var x in Object.keys(document.styleSheets)) {
                ...
                if (M.ownerNode == h) {
                  var _ = { tag: "STYLE", attributes: v, value: la(M) };
                  ce[i](t, o, _, e);
                  break;
                }
              }
  ...
  function la(t) {
    ...
    try {
      ...
      if ((ar(1, 1, t ? t.name : null), t && "SecurityError" !== t.name))
        throw t;
    }
  ...
  function ka() {
    if (
      ...
      (wa = {}),
      null === pa &&
        ((pa = CSSStyleSheet.prototype.insertRule),
        (CSSStyleSheet.prototype.insertRule = function () {
          return ki() && Sa(this.ownerNode), pa.apply(this, arguments);
        })),
      null === va &&
        ((va = CSSStyleSheet.prototype.deleteRule),
            ...
            switch (
              ...
              (c = (function (t, e, n, a) {
                ...
                if (r && "HTML" !== r.data.tag) {
                  ...
                  var l = wa[c];
                  if (
                    (!1 === i && l[0] >= 10 && Ta(l[2], 2, e),
                    (l[0] = i ? (l[1] === n ? l[0] : l[0] + 1) : 1),
                    (l[1] = n),
                    10 === l[0])
                  )
                    return (l[2] = t.removedNodes), "suspend";
                  if (l[0] > 10) return "";
                }
                return t.type;
              })(i, t, n, e.time)),
              ...
              case "characterData":
                ...
                break;
              case "childList":
                Ta(i.addedNodes, 1, t, e.time),
                  Ta(i.removedNodes, 2, t, e.time);
                break;
              case "suspend":
      ...
      at(this, void 0, void 0, function () {
        ...
        return rt(this, function (H) {
          switch (((n = e || s()), (a = [n, t]), t)) {
            ...
            case 19:
            case 20:
              for (r = 0, i = Tn; r < i.length; r++)
                (L = i[r]),
                  (o = _a(L.data.target, L.event)).id > 0 &&
                    ((a = [L.time, L.event]).push(o.id),
                    a.push(L.data.x),
                    a.push(L.data.y),
                    Fa(a),
                    M(L.event, L.data.x, L.data.y));
              Cn();
              break;
            case 9:
              for (u = 0, c = sn; u < c.length; u++)
                (L = c[u]),
                  (l = _a(L.data.target, L.event, L.data.text)),
                  (a = [L.time, L.event]),
                  ...
                  a.push(L.data.eX),
                  a.push(L.data.eY),
                  a.push(L.data.button),
                  a.push(L.data.reaction),
                  a.push(L.data.context),
                  a.push(m(L.data.text, "click", l.privacy)),
                  a.push(b(L.data.link)),
                  a.push(d),
                  a.push(L.data.trust),
                  Fa(a),
                  ja(
              ...
              break;
            case 38:
              for (f = 0, h = gn; f < h.length; f++)
                (L = h[f]),
                  (a = [L.time, L.event]),
                  (A = _a(L.data.target, L.event)).id > 0 &&
                    (a.push(A.id), a.push(L.data.action), Fa(a));
              bn();
              break;
            case 11:
              (p = Nn),
            ...
            case 26:
              ...
              break;
            case 27:
              for (g = 0, y = wn; g < y.length; g++)
                (L = y[g]),
                  (w = _a(L.data.target, L.event, L.data.value)),
                  (a = [L.time, L.event]).push(w.id),
                  a.push(m(L.data.value, "input", w.privacy)),
                  Fa(a);
              On();
              break;
            case 21:
              ...
              break;
            case 10:
              for (N = 0, T = jn; N < T.length; N++)
                (L = T[N]),
                  (S = _a(L.data.target, L.event)).id > 0 &&
                    ((a = [L.time, L.event]).push(S.id),
                    a.push(L.data.x),
                    a.push(L.data.y),
                    a.push(L.data.top),
                    a.push(L.data.bottom),
                    Fa(a),
                    M(L.event, L.data.x, L.data.y, L.time));
              jn = [];
              break;
            case 42:
              for (x = 0, _ = an; x < _.length; x++)
                (L = _[x]),
                  (a = [L.time, L.event]),
                  (A = _a(L.data.target, L.event)).id > 0 &&
                    ((a = [L.time, L.event]).push(A.id),
                    a.push(L.data.type),
                    a.push(m(L.data.value, "change", A.privacy)),
                    a.push(m(L.data.checksum, "checksum", A.privacy)),
                    Fa(a));
              on();
              break;
            case 39:
              for (C = 0, D = Bn; C < D.length; C++)
                (L = D[C]),
                  (a = [L.time, L.event]),
                  (A = _a(L.data.target, L.event)).id > 0 &&
                    (a.push(A.id), Fa(a));
              ...
              break;
            case 22:
              for (j = 0, R = Da; j < R.length; j++)
                (L = R[j]),
                  (a = [L.time, L.event]).push(L.data.type),
                  a.push(L.data.hash),
                  a.push(L.data.x),
                  a.push(L.data.y),
                  a.push(L.data.reaction),
  ...
  function Fa(t, e) {
    if ((void 0 === e && (e = !0), Ha)) {
      ...
      n - qa > 2 * i && (Y(Ya), (Ya = null)),
        e &&
          null === Ya &&
          (25 !== a && V(), (Ya = X(Ba, i)), (qa = n), Or(Xa));
    }
  }
  function Va() {
    Y(Ya),
            ...
            case 0:
              return (
                ...
                (e =
                  !1 === o.lean &&
                  Xa > 0 &&
                  (Xa < 1048576 || ti.sequence > 0)) && W(1, 1),
                Qe(),
                (function () {
                  var t = [];
                  Da = [];
                  for (
                    var e = ti.start + ti.duration,
                      n = Math.max(e - 2e3, 0),
                      a = 0,
                      r = Ca;
                    a < r.length;
  ...
  function Ja(t, e, n, a) {
    if ((void 0 === a && (a = !1), "string" == typeof o.upload)) {
      ...
      if (!1 === i) {
        n in za ? za[n].attempts++ : (za[n] = { data: t, attempts: 1 });
    ...
    t &&
      ...
      ((t.status < 200 || t.status > 208) && n.attempts <= 1
        ...
        : ((Pa = { sequence: e, attempts: n.attempts, status: t.status }),
          ...
          0 === t.status && (Ja(n.data, null, e, !0), Nr(3)),
          t.status >= 200 && t.status <= 208 && Ga(e),
          delete za[e]));
  }
  function Ga(t) {
    1 === t && Ur();
  ...
  function $a(t) {
    var e = t.error || t;
    return (
      e.message in Qa || (Qa[e.message] = 0),
      Qa[e.message]++ >= 5 ||
        (e &&
          e.message &&
          ((Za = {
  ...
  function ar(t, e, n, a, r) {
    ...
    (t in nr && nr[t].indexOf(i) >= 0) ||
      ((er = { code: t, name: n, message: a, stack: r, severity: e }),
      t in nr ? nr[t].push(i) : (nr[t] = [i]),
      tr(33));
  }
  var rr,
    ir = {},
  ...
  function gr(t, e, n) {
    ...
    t in ir || ((ir[t] = {}), (r = !0)),
      (a = sr[t]),
      0 == Object.keys(a).length || (e in ir[t] && ir[t][e] == n) || (r = !0),
      (ir[t][e] = n),
      r && or.add(t);
  }
  function mr() {
  ...
  function Or(t) {
    if (0 === rr.check) {
      var e = rr.check;
      (e = ti.sequence >= 128 ? 1 : e),
        (e = ti.pageNum >= 128 ? 7 : e),
        (e = s() > 72e5 ? 2 : e),
        (e = t > 10485760 ? 2 : e) !== rr.check && Nr(e);
    }
  }
  function Nr(t) {
    (rr.check = t), qr(), zi();
  ...
  function Hr() {
    ...
    (jr = {
      ...
      Cr(0, t),
      Cr(3, e),
      Cr(1, b(location.href, !!Lr)),
      Cr(2, document.referrer),
      Cr(
        15,
        (function () {
          var t = Br();
      ...
      Cr(16, document.documentElement.lang),
      Cr(17, document.dir),
      Cr(26, "".concat(window.devicePixelRatio)),
      Cr(28, r.dob.toString()),
      Cr(29, r.version.toString()),
      W(0, a.ts),
      W(1, 0),
      W(35, Lr),
      navigator &&
        (Cr(9, navigator.language),
  ...
  function Wr(t, e) {
    void 0 === e && (e = !0);
    var n = o.lean ? 0 : 1;
    jr && (n || !1 === e) ? t(jr, !o.lean) : Rr.push({ callback: t, wait: e });
  }
  function Xr() {
  ...
  function Yr(t) {
    if ((void 0 === t && (t = !0), !t))
      return (
        (o.track = !1),
        Qr("_clsk", "", -Number.MAX_VALUE),
        Qr("_clck", "", -Number.MAX_VALUE),
        zi(),
        void window.setTimeout(Li, 250)
      );
  ...
  function Ur() {
    ...
    !(function (t) {
      ...
      Qr("_clsk", [jr.sessionId, t, jr.pageNum, n, e].join("|"), 1);
  }
  function Fr(t, e) {
    try {
      return !!t[e];
  ...
  function Vr(t, e) {
    ...
    (null === t.expiry ||
      ...
      t.consent !== e ||
      t.dob !== a) &&
      Qr("_clck", [jr.userId, 2, n.toString(36), e, a].join("|"), 365);
  }
  function Br() {
  ...
  function Kr() {
    var t = { id: Br(), version: 0, expiry: null, consent: 0, dob: 0 },
      e = Gr("_clck");
    if (e && e.length > 0) {
      for (
      ...
      n.length > 1 && (t.version = Jr(n[1])),
        n.length > 2 && (t.expiry = Jr(n[2], 36)),
        n.length > 3 && 1 === Jr(n[3]) && (t.consent = 1),
        n.length > 4 && Jr(n[1]) > 1 && (t.dob = Jr(n[4])),
      ...
      if (n)
        for (var a = 0; a < n.length; a++) {
          ...
          if (r.length > 1 && r[0] && r[0].trim() === t) {
            for (var i = Zr(r[1]), o = i[0], u = i[1]; o; )
              (o = (e = Zr(u))[0]), (u = e[1]);
            return u;
          }
        }
  ...
  function Qr(t, e, n) {
    if (
      (o.track || "" == e) &&
      ((navigator && navigator.cookieEnabled) || Fr(document, "cookie"))
    ) {
      var a = (function (t) {
      ...
      document.cookie = zr
        ? "".concat(u).concat(";").concat("domain=").concat(zr)
        : u;
    }
  }
  var $r,
  ...
  function ai(t) {
    return (
      (ti.start = ti.start + ti.duration),
      (ti.duration = s() - ti.start),
      ti.sequence++,
      (ti.upload = t && "sendBeacon" in navigator ? 1 : 0),
      (ti.end = t ? 1 : 0),
      [
        ti.version,
        ti.sequence,
  ...
  function ci(t, e, n, a) {
    ...
    try {
      t[u("addEventListener")](e, n, a),
        ui.push({ event: e, target: t, listener: n, capture: a });
    } catch (t) {}
  }
  function si() {
  ...
  var Si = Object.freeze({
    ...
    start: function () {
      Se(),
        ...
        (Ve = {}),
        (Be = []),
        (Je = !!window.IntersectionObserver),
        Ut(),
        o.delayDom
        ...
        at(this, void 0, void 0, function () {
          ...
          return rt(this, function (a) {
            return (
              ...
              (n = [e, t]),
              29 === t &&
                (n.push(Mi.fetchStart),
                n.push(Mi.connectStart),
                n.push(Mi.connectEnd),
                n.push(Mi.requestStart),
                n.push(Mi.responseStart),
                n.push(Mi.responseEnd),
                n.push(Mi.domInteractive),
                n.push(Mi.domComplete),
                n.push(Mi.loadEventStart),
                n.push(Mi.loadEventEnd),
                n.push(Mi.redirectCount),
                n.push(Mi.size),
                n.push(Mi.type),
                n.push(Mi.protocol),
                n.push(Mi.encodedSize),
        ...
        _i(),
          (function () {
            navigator &&
              ...
              Cr(27, navigator.connection.effectiveType),
              window.PerformanceObserver &&
              PerformanceObserver.supportedEntryTypes
                ? "complete" !== document.readyState
                  ? ci(window, "load", X.bind(this, Di, 0))
                  : Di()
                : ar(3, 0);
          })();
      },
